# Generated by Django 4.2.1 on 2023-05-05 11:28
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('cars', '0005_alter_car_created_date_alter_car_description'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='car',
            name='created_date',
            field=models.DateTimeField(blank='true', default=datetime.datetime(2023, 5, 5, 16, 58, 16, 322094)),
        ),
        migrations.AlterField(
            model_name='car',
            name='features',
